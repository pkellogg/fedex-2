...
//his is activated by the ok button in the properties dialog box and is wired for only the header element 
 function headerStyles(x, y , z) {
	 //alert("hi");
document.getElementsByTagName("fedex-header")[0].setAttribute("c", z);
document.getElementsByTagName("fedex-header")[0].setAttribute("width", x); 
document.getElementsByTagName("fedex-header")[0].setAttribute("height", y); 	
}
 
function elementStyle(x, y , z, aa) { 
 
if(aa == 'fxheaderid'){     //id
var gg = "fedex-header";   //tag name
}
//alert(gg);
document.getElementsByTagName(gg)[0].setAttribute("c", z);
document.getElementsByTagName(gg)[0].setAttribute("width", x); 
document.getElementsByTagName(gg)[0].setAttribute("height", y); 	
}
...
var xxx = document.getElementById("jim").files[0].name; //use this format to get rid of filepath secruity measure
$(xx).attr("src",xxx);
}  
