...
//ATTRIBUTES
function elementStyle(fxwidth,fxheight,fxbackcolor,fxzindex,fxopacity,fxleft,fxtop,fxselelement) { 
//alert(fxwidth);
document.getElementById(expressCard).setAttribute("width", 134);
...
//document.getElementById(fxselelement).setAttribute("x", fxleft);  //this conflicts with system generated left and top positioning
//document.getElementById(fxselelement).setAttribute("y", fxtop);
