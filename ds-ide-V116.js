...
//setting content of slots...called by the ok buttons in the property box
function textSlot(bb) 
{
var lolo = document.getElementById(bb);
var tomtom = document.getElementById('headerslot1');
tomtom.innerHTML = $('#setTitle1').val();
}

function textSlot2(bb) 
{
if(bb == 'fxheaderid') {
document.getElementById('headerslot2').innerHTML = $('#setTitle2').val();
}
if(bb == 'fxcardid') {
...
function textSlot3(bb) 
{
if(bb == 'fxheaderid') {
document.getElementById('headerslot3').innerHTML = $('#setTitle3').val();
}
if(bb == 'fxcardid') {
